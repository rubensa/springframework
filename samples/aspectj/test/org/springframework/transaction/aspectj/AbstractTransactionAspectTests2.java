...
// TODO need to duplicate otherwise can't get call pointcuts to work
...
*  @version $Id$
 */
public abstract class AbstractTransactionAspectTests2 extends TestCase {
	...
	protected void doTestRollbackOnException(final Exception ex, final boolean shouldRollback,
		...
		TransactionAttribute txatt = new DefaultTransactionAttribute() {
			public boolean rollbackOn(Throwable t) {
				assertTrue(t == ex);
				System.out.println("rollbackOn...=" + shouldRollback);
	...
	public void testCannotCommitTransaction() throws Exception {
		...
		MapTransactionAttributeSource tas = new MapTransactionAttributeSource();
		tas.register(m, txatt);
		Method m2 = TestBean.class.getMethod("getName", null);
