 ...
 * intermediate .dot file that GraphViz uses to generate the actual images. In
 * addition, it will generate a consolidated image from all supplied context
 * documents.
 * 
...
public class DotFileTransformer extends XslTransformer {
	...
	protected void postTransform() {
		...
		DefaultContextProcessor.setSpringNamespace(beans, false);
		// Element beans = (Element)
		// contextDocuments[0].getRootElement().clone();
