...
public class DocumentCompilerImpl implements DocumentCompiler {
    ...
    public void compile(Document[] contextDocuments, File outputDir) {
        ...
        // find all input files for GraphViz, recursing sub-directories
    ...
    private void plugMap(File mapFile) {
        ...
        File graphFile = new File(
            StringUtils.replace(mapFile.getAbsolutePath(), ".map", filenameStrategy.getFileName(""))
        );
