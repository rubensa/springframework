    ...
    public void compile(Document[] contextDocuments, File outputDir) {
        ...
        if (dotExe != null && new File(dotExe).isFile())
            for (int i = 0; i < dotFileList.size(); i++) {
                ...
                /*
                 * insert map into -graph.html file.  If the source is not
                 * in the root of the outputDir, we need to flatten the
                 * links in the map file generated by dot.
                 */
                plugMap(mapFile, outputDir.getAbsolutePath().equals(
                    dotFile.getParentFile().getAbsolutePath()));
    ...
    private void plugMap(File mapFile, boolean isInRootDir) {
        ...
        try {
            ...
            while ((line = reader.readLine()) != null) {
                // if the file is not in the root, we have to amend the map links
                // generated by dot.  This is messy and slightly unpredictable but
