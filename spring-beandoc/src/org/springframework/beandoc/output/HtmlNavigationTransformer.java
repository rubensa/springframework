 ...
 * @since 1.0
 */
public class HtmlNavigationTransformer extends AbstractConsolidatedTransformer {
    
    private static final String DEFAULT_XSL_RESOURCE = 
        "/org/springframework/beandoc/output/stylesheets/nav.xsl";   

    private static final String FILENAME_NAVIGATOR = "nav.html";
    
    /**
     * default constructor uses the included stylesheet to generate HTML
     * output.
     */
    public HtmlNavigationTransformer() {
     ...
     * @param templateName
     */
    public HtmlNavigationTransformer(String templateName) {
        super(templateName);
    }
