...
<!DOCTYPE xsl:stylesheet [
    <!ENTITY db_xsl_path        "../../../DocBook/lib/docbook-xsl/">
...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0" xmlns="http://www.w3.org/TR/xhtml1/transitional"
    ...
    <!--###################################################
                     Headers and Footers
    ################################################### -->
    <!-- let's have a Spring and beandoc banner across the top of each page -->
    <xsl:template name="user.header.navigation">
        <div style="background-color:white;border:none;height:73px;border:1px solid black;">
            <a style="border:none;" href="http://www.springframework.org/" title="The Spring Framework">
                <img style="border:none;" src="images/xdev-spring_logo.jpg" />
            </a>
            <img style="border:none;position:absolute;right:31px;" src="images/beandoc-banner.png" />
        </div>
    </xsl:template>
                            ...
                            <tr>
                                ...
                                <td width="20%" align="center">
                                    <span style="color:white;font-size:90%;">
                                        <a href="http://springframework.sourceforge.net/beandoc/" title="Spring BeanDoc">Spring BeanDoc</a>
                                    </span>
                                </td>
