...
public class BeanDocLoader {
    ...
    /*
        ...
        */
//            ContextProcessor p = new BeanDocEngine(beanCfg);
...
//            decorators.add(jdd);
//            
//            GraphVizDecorator gvd = new GraphVizDecorator();
//            gvd.addBeanColours("/OrderService*", "#ffcccc");
//            decorators.add(gvd);
//            
//            decorators.add(new HtmlDecorator());
//            
//            transformers.add(new HtmlTransformer());         
//               
//            GraphVizTransformer gvt = new GraphVizTransformer();
//            //gvt.setDotExe("c:/Program Files/ATT/Graphviz/bin/dot.exe");
//            gvt.setDotExe("/usr/bin/dot");
//            gvt.setGraphOutputType("png");
//            transformers.add(gvt);
//            
//            transformers.add(new EchoTransformer());
//            
//            
//            DefaultContextProcessor p = new DefaultContextProcessor(inputFiles, outputDir);
//            p.setValidateFiles(false);
//            p.setTransformers(transformers);
//            p.setDecorators(decorators);
//            p.process();
            ClassPathResource res = new ClassPathResource("/org/springframework/beandoc/client/beandoc.xml");
	...
	public static void usage() {
		StringBuffer usg = new StringBuffer("Usage:\n\n")
			.append("java org.springframework.beandoc.client.BeanDocLoader ")
