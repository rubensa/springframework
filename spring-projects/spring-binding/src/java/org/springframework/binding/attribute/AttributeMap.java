 ...
 * @author Keith Donald
 */
public class AttributeMap extends AbstractAttributeMap implements MutableAttributeCollection {
	 ...
	 */
	public AttributeMap addAttributes(AttributeCollection attributes) {
		if (attributes == null) {
			return this;
		}
