...
/**
 * An evaluator that is capable of setting a property on a target object at 
 * the value path defined by an expression. 
 * @author Keith Donald
 */
public interface PropertyExpression extends Expression {
	
	/**
	 * Set the value of this property expression on the target object
