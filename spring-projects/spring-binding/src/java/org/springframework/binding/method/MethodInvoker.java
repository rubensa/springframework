...
public class MethodInvoker {
	 ...
	 * 
	 * @param methodKey
	 *            the definition of the method to invoke, including the method
	 *            name and the method argument types
	 * @param bean
	 *            the bean to invoke
	 * @param argumentSource
	 *            the source for method argument values
	 * @return the invoked method's return value
	 * @throws IllegalAccessException
	 * @throws IllegalArgumentException
	 * @throws InvocationTargetException
	 */
	public Object invoke(MethodKey methodKey, Object bean,
			AttributeSource argumentSource) throws IllegalAccessException,
		...
		while (it.hasNext()) {
			...
			args[i] = applyTypeConversion(argumentSource.getAttribute(argument
					.getName()), argument.getType());
			i++;
		}
		// TODO - strongly typed unchecked exceptions here?
	...
	protected Object applyTypeConversion(Object rawArgument, Class targetType) {
		...
		return conversionService.getConversionExecutor(rawArgument.getClass(),
				targetType).execute(rawArgument);
	}
}