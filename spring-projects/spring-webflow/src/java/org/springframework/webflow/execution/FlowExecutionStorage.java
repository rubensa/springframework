...
public interface FlowExecutionStorage {
	 ...
	 * {@link #saveWithGeneratedId(Serializable, FlowExecution, Event), or false
	 * if only a one-step save is supported, via a call to
	 ...
	 * save.
	 * @param previousId the unique id of the flow execution, or <code>null</code>
