 ...
 */
public class PortletEvent extends ExternalEvent {
	...
	public PortletEvent(PortletRequest request, PortletResponse response) {
		this(request, response, EVENT_ID_PARAMETER, ServletEvent.EVENT_ID_REQUEST_ATTRIBUTE,
	 ...
	 * sent as part of the name of a request parameter (e.g.
	 * "_eventId_value=bar")
	 */
	public PortletEvent(PortletRequest request, PortletResponse response, String eventIdParameterName,
		...
		// TODO multipart portlet request support -- not yet supported by Spring
		// Portlet MVC
	...
	public Map getApplicationMap() {
		return new PortletContextMap(getRequest().getPortletSession().getPortletContext());
	}

	public Map getSessionMap() {
		return new PortletSessionMap(getRequest().getPortletSession());
	}
}