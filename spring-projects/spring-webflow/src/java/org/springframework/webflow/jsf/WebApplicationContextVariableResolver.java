...
/**
 * Note, this shadows a class that has been added to Spring for v1.2.5. It's here so that there is no
 * need for Web Flow to depend on a CVS version of Spring. As soon as Spring 1.2.5 is 
