...
/**
 * Note, this shadows a class that has been added to Spring for v1.3. It's here so that there is no
 * need for Web Flow to depend on a CVS version of Spring. As soon as Spring 1.3RC1 (or later) is 
 * available, this class may be removed, and that version may be used instead.
 * 
 * <p>
