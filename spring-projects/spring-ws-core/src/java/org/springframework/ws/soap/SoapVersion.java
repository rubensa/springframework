...
/**
 * Interface that defines a specific version. Contains properties for elements
 * that make up a soap envelope.
 * 
...
public interface SoapVersion {
	...
	public static final SoapVersion SOAP_11 = new SoapVersion() {
		...
		private QName ENVELOPE_NAME = new QName(ENVELOPE_NAMESPACE_URI,
				"Envelope", DEFAULT_ENVELOPE_NAMESPACE_PREFIX);

		private QName HEADER_NAME = new QName(ENVELOPE_NAMESPACE_URI,
				"Header", DEFAULT_ENVELOPE_NAMESPACE_PREFIX);

		private QName BODY_NAME = new QName(ENVELOPE_NAMESPACE_URI,
				"Body", DEFAULT_ENVELOPE_NAMESPACE_PREFIX);

		private QName FAULT_NAME = new QName(ENVELOPE_NAMESPACE_URI,
				"Fault", DEFAULT_ENVELOPE_NAMESPACE_PREFIX);

		private QName MUST_UNDERSTAND_NAME = new QName(
				ENVELOPE_NAMESPACE_URI, "mustUnderstand",
				DEFAULT_ENVELOPE_NAMESPACE_PREFIX);

		private QName ACTOR_NAME = new QName(ENVELOPE_NAMESPACE_URI,
				"actor", DEFAULT_ENVELOPE_NAMESPACE_PREFIX);

		private QName CLIENT_FAULT_NAME = new QName(
				ENVELOPE_NAMESPACE_URI, "Client",
				DEFAULT_ENVELOPE_NAMESPACE_PREFIX);

		private QName SERVER_FAULT_NAME = new QName(
				ENVELOPE_NAMESPACE_URI, "Server",
				DEFAULT_ENVELOPE_NAMESPACE_PREFIX);
	...
	public static final SoapVersion SOAP_12 = new SoapVersion() {
		...
		private static final String NEXT_ROLE_URI = ENVELOPE_NAMESPACE_URI
				+ "/role/next";

		private static final String NONE_ROLE_URI = ENVELOPE_NAMESPACE_URI
				+ "/role/none";

		private static final String ULTIMATE_RECEIVER_ROLE_URI = ENVELOPE_NAMESPACE_URI
		...
		private QName ROLE_NAME = new QName(ENVELOPE_NAMESPACE_URI,
				"role", DEFAULT_ENVELOPE_NAMESPACE_PREFIX);

		private QName SENDER_FAULT_NAME = new QName(
				ENVELOPE_NAMESPACE_URI, "Sender",
				DEFAULT_ENVELOPE_NAMESPACE_PREFIX);

		private QName RECEIVER_FAULT_NAME = new QName(
				ENVELOPE_NAMESPACE_URI, "Receiver",
				DEFAULT_ENVELOPE_NAMESPACE_PREFIX);
	...
	/**
	 * Returns the qualified name of the SOAP <code>MustUnderstand</code>
	 * attribute and SOAP Fault value.
	 */
	QName getMustUnderstandName();

	/**
	 * Returns the URI indicating that a header element is intended for the next
	 * SOAP application that processes the message.
	 */
	...
	/**
	 * Returns the qualified name of the SOAP <code>actor</code>/<code>role</code>
	 * attribute.
	 */
	QName getRoleName();
	...
	/**
	 * Returns the URI indicating that a header element should only be processed
	 * by nodes acting as the ultimate receiver of a message.
	 */
