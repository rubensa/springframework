...
public class StaxStreamXmlReaderTest extends TestCase {
    ...
    public void testContentHandler() throws SAXException, IOException, XMLStreamException {
        ...
        reader.parse(new InputSource(new StringReader(StaxStreamXmlReaderTest.XML_CONTENT_HANDLER)));
        control.replay();
        XMLStreamReader streamReader =
                inputFactory.createXMLStreamReader(new StringReader(StaxStreamXmlReaderTest.XML_CONTENT_HANDLER));
        StaxStreamXmlReader staxStreamXMLReader = new StaxStreamXmlReader(streamReader);
        staxStreamXMLReader.setContentHandler(mock);
        staxStreamXMLReader.parse("");
        control.verify();
    }
    ...
    public void testDtdHandler() throws IOException, SAXException, XMLStreamException {
        ...
        reader.parse(new InputSource(new StringReader(StaxStreamXmlReaderTest.XML_DTD_HANDLER)));
        control.replay();
        XMLEventReader eventReader =
                inputFactory.createXMLEventReader(new StringReader(StaxStreamXmlReaderTest.XML_DTD_HANDLER));
