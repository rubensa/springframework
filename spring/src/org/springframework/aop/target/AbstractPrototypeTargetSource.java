 ...
 * Such TargetSources must run in a BeanFactory, as it needs
 * to call the getBean() method to create a new prototype
 * instance.
 * @author Rod Johnson
 * @version $Id$
 */
public abstract class AbstractPrototypeTargetSource implements TargetSource, BeanFactoryAware {
	 ...
	 * We need to hold onto this reference so that we can create new prototype
