...
public abstract class StringUtils {
    ...
    /**
     * Determine if the given Strings are equal, returning true if both are
     * null respectively false if only one is null.
     * 
     * @param s1
    ...
    /**
     * Convenience method to return a String array as a CSV String. Useful for
    ...
    /**
     * Convenience method to return a Collection as a CSV String. Useful for
     * toString() implementations.
     * 
     * @param c
     *            Collection to display
     ...
     * lower case as per {@link Character#toLowerCase(char)}. No other letters
     * are changed.
     * 
     * @param str
